...
import { CredentialDownloadModal } from '@zippyra/ui';
...
describe('CredentialDownloadModal Component', () => {
  ...
  test('Done & Dismiss button is disabled until confirmation checkbox is checked', () => {
  ...
  test('Download bundle triggers single file download url creation', () => {
    const onConfirmed = jest.fn();
